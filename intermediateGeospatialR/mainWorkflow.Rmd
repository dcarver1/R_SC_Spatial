...
this allows you toconnect functions output, input output, Input, and it makes for efficient code. 
...
## one last thing 
Ahh, while the corraltive relationships between our census tract metrics and the nightlight radience do look great on paper, they might look better on a map. 
