...
You can find a more comprehesive description of the VIIRS monthly composites by opening
<br>
...
```{r, echo = FALSE}
knitr::include_graphics("E:/R_SC_Spatial/intermediateGeospatialR/data/pngsForMarkdown/light.jpg")
