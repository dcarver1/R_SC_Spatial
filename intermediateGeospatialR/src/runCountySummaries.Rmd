...
rmarkdown::render(input = "D:/R_SC_Spatial/intermediateGeospatialR/src/countySummaries.Rmd",
                  output_file="D:/R_SC_Spatial/intermediateGeospatialR/src/summary_test")
```
...
rmarkdown::render(input = "D:/R_SC_Spatial/intermediateGeospatialR/src/countySummaries.Rmd",
                  output_file="D:/R_SC_Spatial/intermediateGeospatialR/src/summary_test_ 2")
```
...
# provide a path to the file and an output lication 
rmarkdown::render(input = "D:/R_SC_Spatial/intermediateGeospatialR/src/countySummaries.Rmd",
                  output_file="D:/R_SC_Spatial/intermediateGeospatialR/src/summary_test_3")
```
...
for(i in counties ){
  ...
  rmarkdown::render(input = "D:/R_SC_Spatial/intermediateGeospatialR/src/countySummaries.Rmd",
                  output_file=paste0("D:/R_SC_Spatial/intermediateGeospatialR/src/summary_test_",i))
}
